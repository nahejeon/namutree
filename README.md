NamuTree is a web app for you to study your own vocab.

### A consolidated view to keep track of all your vocab, organized into folders
...
### Able to add vocab, meaning, notes for each vocab
...
### You can turn on "Study mode", where meaning and notes are hidden, except for the vocab you hover over
...
### Able to sort vocab from newest to oldest, as well as oldest to newest
<img width="222" alt="Screenshot 2025-07-07 at 8 58 55 PM" src="https://github.com/user-attachments/assets/6be8cb74-f9e4-4c4f-95ae-d7516b95ef0e" />

### Search functionality, which highlights the search items
