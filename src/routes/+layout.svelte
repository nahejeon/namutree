...
<div class="drawer lg:drawer-open">
      ...
      {#if session && !user?.is_anonymous}
        ...
        <div class="flex items-center gap-2 ml-2">
          <div class="hidden md:block">
            Hi <span class="font-bold">{profileName}</span>!
          </div>
          ...
          <div class="dropdown dropdown-end">
            <div
              tabindex="0"
              role="button"
              class="btn btn-ghost btn-circle m-1 px-1 justify-between"
            >
              <SettingsIcon />
            </div>

            <ul
              class="menu dropdown-content bg-base-100 rounded-box z-1 w-32 p-2 shadow-sm"
            >
  ...
  <div class="drawer-side">
    ...
    ></label>
    <div
      class="flex flex-col justify-between bg-primary text-base-100 p-4 min-h-screen"
    >
      <div>
        <!-- Logo -->
        <a href="/" class="flex gap-2">
          ...
          <h1 class="text-2xl text-accent font-chilanka">NAMUTREE</h1>
        </a>
          ...
          <li>
            ...
            <ul>
              {#each folders as folder}
                <FolderListItem {folder} editing={false} />
              {/each}
      ...
      <div>
        <a
          href="https://www.flaticon.com/free-icons/eco-friendly"
          title="eco friendly icons"
          class="text-xs block font-chilanka text-primary-content/50 text-serif pt-1"
          >Eco friendly icons created by <br /> Freepik - Flaticon</a
        >

        <!-- New folder button -->
        <button
          class="flex items-center gap-2 font-light text-base cursor-pointer"
