    ...
    <div class="card-body gap-0">
      ...
      {:else if !forgotPassword}
        ...
        <form method="POST" action="?/login">
          ...
          <div class="mt-2 underline text-gray-700">
            <button
              class="link"
          ...
          <!-- Buttons -->
          <button
            class="btn btn-neutral mt-4 shadow-none w-full mt-6"
      ...
      {:else}
        ...
        <form method="POST" action="?/resetPassword">
          ...
          <h4 class="text-xl font-medium text-gray-400 mb-5">
          ...
          <div class="flex flex-col mt-3">
            ...
            <div class="mt-2 underline text-gray-700 self-center">
              <button class="link" onclick={() => (forgotPassword = false)}
                >Go back</button
              >
            </div>
          </div>
          ...
          {#if resetFail}
            <p class="text-error text-xs italic mt-2">
              Request failed. Try again after 5 seconds.
            </p>
          {/if}
        </form>
      {/if}
